      ...
      <section className='course-section'>
        <div className='course-section-search-find-box'>
          <button className='course-section-search-find-box-button'>
            ...
            <input className='course-section-search-find-box-input-button' type="text" name="" placeholder='Search' id="" />
          </button>
          ...
          <div className='course-section-content-listchecked'>
            <div className='course-section-content-checked'>
              ...
              <span className='course-section-content-checked-box'>
                <input className='course-section-content-checked-icon' type="checkbox" name="" id="" />
                <p className='course-section-content-checked-subheading'>Course</p>
              </span>
            </div>
            <div className='course-section-content-checked'>
              <h2 className='course-section-content-checked-heading'>Category</h2>
              <span className='course-section-content-checked-box'>
                <input className='course-section-content-checked-icon' type="checkbox" name="" id="" />
            ...
            <div className='course-section-content-checked'>
              ...
              <span className='course-section-content-checked-box'>
                <input className='course-section-content-checked-icon' type="checkbox" name="" id="" />
                <p className='course-section-content-checked-subheading'>All Levels</p>
              </span>
            </div>
            <div className='course-section-content-checked'>
              ...
              <span className='course-section-content-checked-box'>
                <input className='course-section-content-checked-icon' type="checkbox" name="" id="" />
                <p className='course-section-content-checked-subheading'>Free</p>
              </span>
            </div>
          </div>
