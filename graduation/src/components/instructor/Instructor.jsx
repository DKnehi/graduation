      ...
      <section className="instructor-section">
            ...
            <div className="instructor-section-info-box2">
              <div className="info-box-avatar">
                <img
                  ...
                  src="https://demo.themeum.com/tutor/wp-content/uploads/2022/02/Avatar-5.jpg"
                  alt=""
                />
              </div>
        ...
        <div className="instructor-section-list-card">
          ...
          <p className="instructor-section-list-card-subheading">
            Hi, I'm Tony Hanna. I'm an avid outdoor photographer and explorer
            and have been taking pictures for years. I've worked professionally
            taking photos but my true passion lies in teaching what I love to
            others.
          </p>
